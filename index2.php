...
$query=mysqli_query($con,"SELECT * FROM tbladmin WHERE AdminUserName='$regno' and AdminPassword='$password'");
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Jc Construction Ltd</title>
